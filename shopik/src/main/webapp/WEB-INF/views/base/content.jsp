...
<div class="container">
	<div class="row">
		<div class="col-md-3">
			<p class="lead">Shopik</p>
			<div class="list-group">
				<a href="#" class="list-group-item"><spring:message
						code="header.laptops_netbooks" /></a> <a href="#"
					class="list-group-item"><spring:message code="header.tablets" /></a>
				<a href="#" class="list-group-item"><spring:message
						code="header.desktops" /></a> <a href="#" class="list-group-item"><spring:message
						code="header.accessories" /></a> <a href="#" class="list-group-item"><spring:message
						code="header.components" /></a>
			</div>
		</div>
		<div class="col-md-9">
